        ...
        <div className="min-h-screen bg-[#0a0a0f] text-white overflow-x-hidden font-sans selection:bg-secondary selection:text-white">
            ...
            <section className="py-24 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold mb-4">Why Socialin is Purrfect</h2>
            ...
            <section className="py-32 text-center px-6">
                ...
                <Link href="/signup" className='flex justify-center'>
                    <Button className="bg-secondary hover:bg-secondary/90 text-white px-10 py-6 rounded-full font-bold text-xl ">
                        Signup Now
                    </Button>
                </Link>
            </section>
            ...
            <footer className="border-t border-white/5 py-12 bg-[#050508]">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <p className="text-sm text-gray-600">
                        © 2024 Socialin. All rights reserved.
                    </p>
                </div>
            </footer>
        </div>
