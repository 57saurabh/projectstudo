...
export default function MultiSelectDropdown({
    ...
    return (
        <div className="w-full relative" ref={dropdownRef}>
            ...
            {/* Trigger Area */}
            <div
                className={`min-h-[42px] w-full bg-surface-hover/50 border rounded-2xl px-4 py-3 transition-all flex items-center justify-between shadow-sm ${disabled
                        ? 'opacity-60 cursor-not-allowed border-border'
                        : isOpen
                            ? 'border-gold ring-1 ring-gold/50 cursor-pointer'
